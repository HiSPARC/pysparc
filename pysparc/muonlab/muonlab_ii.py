...
class MuonlabIIConfig(object):

    def __init__(self, hardware):
        """Initialize muonlab II configuration.

        :param hardware: instance of muonlab hardware class

        """
        self._hardware = hardware

        self.pmt1_voltage = 300
        self.pmt2_voltage = 300
        self.pmt1_threshold = 0
        self.pmt2_threshold = 0
        self.mode = 'lifetime'

    @property
    def pmt1_voltage(self):
        return self._pmt1_voltage

    @pmt1_voltage.setter
    def pmt1_voltage(self, value):
        self._pmt1_voltage = value
        self._hardware._set_pmt1_voltage(value)

    @property
    def pmt2_voltage(self):
        return self._pmt2_voltage

    @pmt2_voltage.setter
    def pmt2_voltage(self, value):
        self._pmt2_voltage = value
        self._hardware._set_pmt2_voltage(value)

    @property
    def pmt1_threshold(self):
        return self._pmt1_threshold

    @pmt1_threshold.setter
    def pmt1_threshold(self, value):
        self._pmt1_threshold = value
        self._hardware._set_pmt1_threshold(value)

    @property
    def pmt2_threshold(self):
        return self._pmt2_threshold

    @pmt2_threshold.setter
    def pmt2_threshold(self, value):
        self._pmt2_threshold = value
        self._hardware._set_pmt2_threshold(value)
    ...
    def mode(self, value):
        if value == 'lifetime':
            self._mode = value
            self._hardware._set_lifetime_measurement()
        elif value == 'coincidence':
            self._mode = value
            self._hardware._set_coincidence_measurement()
        else:
